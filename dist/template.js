...
class Template extends base_pass_1.PassBase {
    constructor(style, fields = {}, images, localization) {
    ...
    static async fromBuffer(buffer) {
        ...
        for await (const entry of zip) {
            ...
            if (/\/?pass\.json$/i.test(entry.fileName)) {
                ...
                template = new Template(undefined, passJSON, template.images, template.localization);
            }
            else {
    ...
    createPass(fields = {}) {
        ...
        return new pass_1.Pass(this, { ...this.fields, ...fields }, this.images, this.localization);
    }
}
