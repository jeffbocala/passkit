...
export declare class Template extends PassBase {
    ...
    private apn?;
    constructor(style?: PassStyle, fields?: Partial<ApplePass>, images?: import('./lib/images').PassImages, localization?: import('./lib/localizations').Localizations);
    /**
     ...
     * @memberof Template
     */
    static load(folderPath: string, keyPassword?: string): Promise<Template>;
    /**
     * Load template from a given buffer with ZIPped pass/template content
     *
     * @param {Buffer} buffer
     */
    static fromBuffer(buffer: Buffer): Promise<Template>;
    /**
     *
